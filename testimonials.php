...
<!-- Mirrored from commonsupport.com/mamnun/saveus/testimonials.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 15 Jun 2023 06:34:01 GMT -->
<head>
    <meta charset="utf-8">
                                ...
                                <nav class="main-menu navbar-expand-md navbar-light">
                                    <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                                        <ul class="navigation clearfix">
                                            ...
                                            <li class="dropdown"><a href="causes.php">Causes</a>
                                                <ul>
                                                    <li><a href="causes.php" >Causes</a></li>
                                                    <li><a href="causes-details.php">Cause Details</a></li>
                                                </ul>
                                            </li>
            ...
            <div class="row">
                <div class="col-xl-4 col-lg-6">
                    <div class="testimonial-wrapper wow fadeInUp" data-wow-delay="1200ms" data-wow-duration="1500ms">
                        <div class="testimonial-main-image">
                            <img src="assets/images/team/t1.png" alt="img">
                ...
                <div class="col-xl-4 col-lg-6">
                    <div class="testimonial-wrapper wow fadeInUp" data-wow-delay="900ms" data-wow-duration="1500ms">
                        <div class="testimonial-main-image">
                            <img src="assets/images/team/t2.png" alt="img">
                            <div class="test-quiet">
                                <i class="flaticon-quote"></i>
                            </div>
                        </div>
                ...
                <div class="col-xl-4 col-lg-6">
                    <div class="testimonial-wrapper wow fadeInUp" data-wow-delay="600ms" data-wow-duration="1500ms">
                        <div class="testimonial-main-image">
                            <img src="assets/images/team/t3.png" alt="img">
                            <div class="test-quiet">
                                <i class="flaticon-quote"></i>
                            </div>
                        </div>
                ...
                <div class="col-xl-4 col-lg-6">
                    <div class="testimonial-wrapper wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <div class="testimonial-main-image">
                            <img src="assets/images/team/t4.png" alt="img">
                            <div class="test-quiet">
                                <i class="flaticon-quote"></i>
                            </div>
                        </div>
                ...
                <div class="col-xl-4 col-lg-6">
                    <div class="testimonial-wrapper wow fadeInUp" data-wow-delay="300ms" data-wow-duration="1500ms">
                        <div class="testimonial-main-image">
                            <img src="assets/images/team/t5.png" alt="img">
                            <div class="test-quiet">
                                <i class="flaticon-quote"></i>
                            </div>
                        </div>
                ...
                <div class="col-xl-4 col-lg-6">
                    <div class="testimonial-wrapper wow fadeInUp" data-wow-delay="600ms" data-wow-duration="1500ms">
                        <div class="testimonial-main-image">
                            <img src="assets/images/team/t6.png" alt="img">
                            <div class="test-quiet">
                                <i class="flaticon-quote"></i>
                            </div>
                        </div>
                                    ...
                                    <div class="footer_widget links_widget ml_100">
                                        ...
                                        <div class="widget_content">
                                            <ul class="links_list clearfix">
                                                ...
                                                <li><a href="events-details.php">Latest News</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="footer_widget links_widget">
                                        ...
                                        <div class="widget_content">
                                            <ul class="links_list clearfix">
                                                ...
                                                <li><a href="causes.php">Food Donation</a></li>
                                                <li><a href="team.php">Medical Help</a></li>
                                                <li><a href="events-carousel.php">Technology</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
...
<!-- Mirrored from commonsupport.com/mamnun/saveus/testimonials.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 15 Jun 2023 06:34:03 GMT -->
</html>
