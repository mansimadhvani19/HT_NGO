                        ...
                        <div class="causes-card">
                            ...
                            <!-- <div class="causes-bar">
                                <div id="skills-section-two">
                                    <div class="progress">
                                        <div class="progress-bar" data-progress="65" style="opacity: 1; width: 65%;">
                                            <span>65%</span>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="causes-card">
                            ...
                            <!-- <div class="causes-bar causes-bar-3">
                                <div id="skills-section-three">
                                    <div class="progress">
                                        <div class="progress-bar" data-progress="80" style="opacity: 1; width: 80%;">
                                            <span>80%</span>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="causes-card">
                            ...
                            <!-- <div class="causes-bar">
                                <div id="skills-section-four">
                                    <div class="progress">
                                        <div class="progress-bar" data-progress="70" style="opacity: 1; width: 70%;">
                                            <span>70%</span>
                                        </div>
                                    </div>
                                </div>
